...
test: board.c eval.c moves.c twoPlayer.c magicNumbers.c magicGeneration.c
	gcc -o test -O3 -std=c99 board.c eval.c moves.c twoPlayer.c magicNumbers.c magicGeneration.c
